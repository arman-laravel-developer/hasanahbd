...
//        Route::get('/complete/{id}', [\App\Http\Controllers\Admin\OrderController::class, 'complete'])->name('order.complete');
    ...
    Route::get('/admin/google-tag-manager', [\App\Http\Controllers\Admin\SettingController::class, 'facebookGoogleForm']);
    Route::post('/admin/google-tag-manager/store', [\App\Http\Controllers\Admin\SettingController::class, 'facebookGoogleFormStore'])->name('admin.google.facebook.code.store');
